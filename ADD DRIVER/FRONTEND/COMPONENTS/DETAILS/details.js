  ...
  addEventListeners(nextPageCallback) {
    ...
    nextBtn.addEventListener("click", async (event) => {
      ...
      try {
        ...
        const result = await addPersonalDetails(formData); //apicalls
  ...
  addEventListeners(nextPageCallback) {
    ...
    nextBtn.addEventListener("click", async (event) => {
      ...
      try {
        ...
        const result = await addVehicleDetails(formData);
  ...
  addEventListeners(nextPageCallback) {
    ...
    nextBtn.addEventListener("click", async (event) => {
      ...
      try {
        ...
        const result = await addBankDetails(formData); // Send data to server
